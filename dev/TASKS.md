...
> the `core-modules.txt` hard floor; `sql_keywords.rs` left off (static, branchless). **293 tests**
> (was 246 entering Phase 3). Remaining: P3.5 candidates, P3.6 framework reuse, P3.7 value wiring.
